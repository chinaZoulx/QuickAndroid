...
public class SideBarView extends View {
    ...
    private void init() {
        ...
        sideTextSpac = FormatUtils.dip2px(getContext(), 10);

        sideTextSize = FormatUtils.dip2px(getContext(), 10);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = b.size() * (FormatUtils.getFontHeight(sideTextPaint) + sideTextSpac) + sideTextSpac * 2;
