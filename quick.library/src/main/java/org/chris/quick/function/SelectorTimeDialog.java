...
import org.chris.quick.widgets.RollView;
...
/**
 * 时间选择
 * The class is a select year and month and day and hour and minute
 */
public class SelectorTimeDialog {
    ...
    private RollView year_pv;
    private RollView month_pv;
    private RollView day_pv;
    private RollView hour_pv;
    private RollView minute_pv;
    ...
    private int startYear, startMonth, startDay, startHour, startMininute, endYear, endMonth,
            endDay, endHour, endMininute, minute_workStart, minute_workEnd, hour_workStart,
            hour_workEnd;
    ...
    public SelectorTimeDialog(Context context, OnResultHandler resultHandler, String startDate, String endDate) {
        ...
        if (!TextUtils.isEmpty(startDate)) {
            startCalendar.setTime(DateUtils.INSTANCE.formatToDate(startDate, FORMAT_STR));
        }
        if (!TextUtils.isEmpty(endDate)) {
            endCalendar.setTime(DateUtils.INSTANCE.formatToDate(endDate, FORMAT_STR));
        }
    ...
    public SelectorTimeDialog(Context context, OnResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
    ...
    private void initDialog() {
        ...
        if (selectorDialog == null) {
            ...
            selectorDialog.setContentView(R.layout.dialog_selector_time);
    ...
    private void initView() {
        ...
        year_pv = (RollView) selectorDialog.findViewById(R.id.year_pv);
        month_pv = (RollView) selectorDialog.findViewById(R.id.month_pv);
        day_pv = (RollView) selectorDialog.findViewById(R.id.day_pv);
        hour_pv = (RollView) selectorDialog.findViewById(R.id.hour_pv);
        minute_pv = (RollView) selectorDialog.findViewById(R.id.minute_pv);
        ...
        year_text = (TextView) selectorDialog.findViewById(R.id.year_text);
        month_text = (TextView) selectorDialog.findViewById(R.id.month_text);
        day_text = (TextView) selectorDialog.findViewById(R.id.day_text);
        hour_text = (TextView) selectorDialog.findViewById(R.id.hour_text);
        minute_text = (TextView) selectorDialog.findViewById(R.id.minute_text);
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String date = DateUtils.INSTANCE.formatToStr(selectedCalender.getTime(), FORMAT_STR);
                if (mode != null) {
                    switch (mode) {
                        case YM:
                            date = DateUtils.INSTANCE.formatToStr(selectedCalender.getTime(), "yyyy-MM");
                            break;
                        case YMD:
                            date = DateUtils.INSTANCE.formatToStr(selectedCalender.getTime(), "yyyy-MM-dd");
                            break;
                        case YMDHM:
                            date = DateUtils.INSTANCE.formatToStr(selectedCalender.getTime(), "yyyy-MM-dd HH:mm");
                            break;
                        case DM:
                            date = DateUtils.INSTANCE.formatToStr(selectedCalender.getTime(), "HH:mm");
                            break;
                    }
                }
                handler.handle(date);
    ...
    private void initTimer() {
        ...
        if (spanYear) {
            ...
            for (int i = startDay;
                 i <= startCalendar.getActualMaximum(Calendar.DAY_OF_MONTH); i++) {
        ...
        if (!TextUtils.isEmpty(workStart_str) && !TextUtils.isEmpty(workEnd_str)) {
            ...
            if (startTime.getTime().getTime() == endTime.getTime().getTime() ||
                    (startWorkTime.getTime().getTime() < startTime.getTime().getTime() &&
                            endWorkTime.getTime().getTime() <
                                    startTime.getTime().getTime())) {
                Toast.makeText(context, "Wrong parames!", Toast.LENGTH_LONG).show();
                return false;
            }
            startCalendar.setTime(startCalendar.getTime().getTime() <
                    workStartCalendar.getTime()
                            .getTime() ? workStartCalendar
                    .getTime() : startCalendar.getTime());
            endCalendar.setTime(endCalendar.getTime().getTime() >
                    workEndCalendar.getTime().getTime() ? workEndCalendar
    ...
    private void addListener() {
        ...
        year_pv.setOnSelectListener(new RollView.onSelectListener() {
        ...
        month_pv.setOnSelectListener(new RollView.onSelectListener() {
        ...
        day_pv.setOnSelectListener(new RollView.onSelectListener() {
        ...
        hour_pv.setOnSelectListener(new RollView.onSelectListener() {
...
//                }
        ...
        minute_pv.setOnSelectListener(new RollView.onSelectListener() {
    ...
    private void loadComponent() {
        ...
        year_pv.setSelected(selectedCalender.get(Calendar.YEAR) + "");
        month_pv.setSelected(selectedCalender.get(Calendar.MONTH) > 9 ?
                selectedCalender.get(Calendar.MONTH) + "" :
                "0" + (selectedCalender.get(Calendar.MONTH) + 1));
        day_pv.setSelected(selectedCalender.get(Calendar.DAY_OF_MONTH) > 9 ?
                selectedCalender.get(Calendar.DAY_OF_MONTH) + "" :
                "0" + selectedCalender.get(Calendar.DAY_OF_MONTH));
        hour_pv.setSelected(selectedCalender.get(Calendar.HOUR_OF_DAY) > 9 ?
                selectedCalender.get(Calendar.HOUR_OF_DAY) + "" :
                "0" + selectedCalender.get(Calendar.HOUR_OF_DAY));
        minute_pv.setSelected(selectedCalender.get(Calendar.MINUTE) > 9 ?
                selectedCalender.get(Calendar.MINUTE) + "" :
    ...
    public void setSelectDate(String dateStr) {
        ...
        selectedCalender.setTime(DateUtils.INSTANCE.formatToDate(dateStr, FORMAT_STR));
    }
    ...
    public static class Builder {
        ...
        private static SelectorTimeDialog sMSelectorTimeDialog;

        public static Builder getInstance(Context context, OnResultHandler onResultHandler, String startDate, String endDate) {

            if (instance == null) {
                instance = new Builder();
            }
            if (sMSelectorTimeDialog == null) {
                sMSelectorTimeDialog = new SelectorTimeDialog(context, onResultHandler, startDate, endDate);
            }
            return instance;
        }
        ...
        public Builder setIsLoop(boolean isLoop) {
            ...
            sMSelectorTimeDialog.setIsLoop(isLoop);
            return this;
        }

        public Builder show() {

            sMSelectorTimeDialog.show();
            return this;
        }

        public SelectorTimeDialog build() {

            return sMSelectorTimeDialog;
        }
    }
