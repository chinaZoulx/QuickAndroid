...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        textColor = (int) a.getColor(R.styleable.ProgressWheel_pwTextColor, textColor);
        ...
        rimColor = (int) a.getColor(R.styleable.ProgressWheel_pwRimColor, rimColor);

        circleColor = (int) a.getColor(R.styleable.ProgressWheel_pwCircleColor, circleColor);
