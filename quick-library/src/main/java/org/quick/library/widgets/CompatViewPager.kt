 ...
 */
class CompatViewPager : androidx.viewpager.widget.ViewPager {
     ...
     * 单击
     */
    private fun onItemClick(adapter: androidx.viewpager.widget.PagerAdapter, currentItem: Int) {
    ...
    interface OnItemClickListener {
        fun onItemClick(adapter: androidx.viewpager.widget.PagerAdapter, currentItem: Int, itemView: View)
    }
    ...
    class TransformerFactory {
        ...
        fun getTransformer(viewPager: androidx.viewpager.widget.ViewPager, type: TransformerType): androidx.viewpager.widget.ViewPager.PageTransformer = when (type) {
        ...
        inner class DepthPageTransformer : androidx.viewpager.widget.ViewPager.PageTransformer {
            val MIN_SCALE = 0.75f
        ...
        inner class ZoomOutPageTransformer : androidx.viewpager.widget.ViewPager.PageTransformer {
            ...
            override fun transformPage(view: View, position: Float) {
                ...
                Log2.e("TAG", view.toString() + " , " + position + "")
        ...
        inner class FlagPageTransformer : androidx.viewpager.widget.ViewPager.PageTransformer {
            private val MIN_SCALE = 0.85f
            private val MIN_ALPHA = 0.5f
            @SuppressLint("NewApi")
            override fun transformPage(view: View, position: Float) {
        ...
        inner class FlymePageTransformer(private val mViewPager: androidx.viewpager.widget.ViewPager) : androidx.viewpager.widget.ViewPager.PageTransformer {
