...
public interface _IScaleView {
	...
	/**
	 * Register activity callback to be invoked when the Scale displayed by this view
	 * is long-pressed.
	 * 
	 * @param listener
	...
	/**
	 * Register activity callback to be invoked when the Matrix has changed for this
	 * View. An example would be the user panning or scaling the Scale.
	 * 
	 * @param listener
	 *            - Listener to be registered.
	 */
	void setOnMatrixChangeListener ( _ScaleViewAttacher.OnMatrixChangedListener listener );

	/**
	 * Register activity callback to be invoked when the Scale displayed by this View
	 * is tapped with activity single tap.
	 * 
	 * @param listener
	 *            - Listener to be registered.
	 */
	void setOnScaleTapListener ( _ScaleViewAttacher.OnScaleTapListener listener );

	/**
	 * Register activity callback to be invoked when the View is tapped with activity single
	 * tap.
	 * 
	 * @param listener
	 *            - Listener to be registered.
	 */
	void setOnViewTapListener ( _ScaleViewAttacher.OnViewTapListener listener );
