...
import org.quick.library.widgets.CustomCompatViewPager;
import org.quick.component.utils.CommonUtils;
import org.quick.component.utils.FormatUtils;import org.quick.library.b.fragments.ThemeFragment;
...
//                }
    ...
    public View onResultIndicatorDot() {
        ...
        int size = (int) FormatUtils.INSTANCE.formatDip2Px(onResultIndicatorDotSize());
        int margin = (int) FormatUtils.INSTANCE.formatDip2Px(onResultIndicatorDotMargin());
    ...
    /**
     *
     * @return should using {@link CustomCompatViewPager.TransformerFactory.Companion#getInstance()} and {@link org.quick.library.widgets.CustomCompatViewPager.TransformerFactory.TransformerType#Depth} or {@link org.quick.library.widgets.CustomCompatViewPager.TransformerFactory.TransformerType#ZoomOut} {@link org.quick.library.widgets.CustomCompatViewPager.TransformerFactory.TransformerType#Flag} {@link org.quick.library.widgets.CustomCompatViewPager.TransformerFactory.TransformerType#Flyme}
     */
    ...
    public void setScrollTimeType(int type) {
        if (viewPagerScrollTime != type)
            CommonUtils.INSTANCE.controlViewPagerSpeed(getViewPager(), viewPagerScrollTime = type);
    }
