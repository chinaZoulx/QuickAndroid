...
public class MobileCheckUtils {
    ...
    /**
     * 中国电信号码格式验证 手机段： 133,153,180,181,189,199,177,173,1700
     **/
     ...
     **/
    private static final String CHINA_UNICOM_PATTERN = "(^1(3[0-2]|4[5]|5[56]|6[6]|7[6]|8[56])\\d{8}$)|(^1709\\d{7}$)";
